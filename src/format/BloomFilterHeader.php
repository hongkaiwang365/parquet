...
class BloomFilterHeader
{
    ...
    static public $_TSPEC = array(
        ...
        2 => array(
            ...
            'isRequired' => true,
            'type' => TType::STRUCT,
            'class' => '\hongkaiwang365\parquet\format\BloomFilterAlgorithm',
        ),
        3 => array(
            'var' => 'hash',
            'isRequired' => true,
            'type' => TType::STRUCT,
            'class' => '\hongkaiwang365\parquet\format\BloomFilterHash',
        ),
        4 => array(
            'var' => 'compression',
            'isRequired' => true,
            'type' => TType::STRUCT,
            'class' => '\hongkaiwang365\parquet\format\BloomFilterCompression',
        ),
    );
     ...
     * 
     * @var \hongkaiwang365\parquet\format\BloomFilterAlgorithm
     */
    public $algorithm = null;
    /**
     * The hash function used for Bloom filter. *
     * 
     * @var \hongkaiwang365\parquet\format\BloomFilterHash
     */
    public $hash = null;
    /**
     * The compression used in the Bloom filter *
     * 
     * @var \hongkaiwang365\parquet\format\BloomFilterCompression
     */
            ...
            switch ($fid) {
                ...
                case 2:
                    if ($ftype == TType::STRUCT) {
                        $this->algorithm = new \hongkaiwang365\parquet\format\BloomFilterAlgorithm();
                ...
                case 3:
                    if ($ftype == TType::STRUCT) {
                        $this->hash = new \hongkaiwang365\parquet\format\BloomFilterHash();
                ...
                case 4:
                    if ($ftype == TType::STRUCT) {
                        $this->compression = new \hongkaiwang365\parquet\format\BloomFilterCompression();
