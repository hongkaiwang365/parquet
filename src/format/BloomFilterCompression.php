...
class BloomFilterCompression
{
    ...
    static public $_TSPEC = array(
        1 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkaiwang365\parquet\format\Uncompressed',
        ),
    );

    /**
     * @var \hongkaiwang365\parquet\format\Uncompressed
     */
            ...
            switch ($fid) {
                case 1:
                    if ($ftype == TType::STRUCT) {
                        $this->UNCOMPRESSED = new \hongkaiwang365\parquet\format\Uncompressed();
