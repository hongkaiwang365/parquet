...
class ColumnChunk
{
    ...
    static public $_TSPEC = array(
        ...
        3 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkaiwang365\parquet\format\ColumnMetaData',
        ),
        4 => array(
        ...
        8 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkaiwang365\parquet\format\ColumnCryptoMetaData',
        ),
        9 => array(
     ...
     * 
     * 
     * @var \hongkaiwang365\parquet\format\ColumnMetaData
     */
     ...
     * 
     * @var \hongkaiwang365\parquet\format\ColumnCryptoMetaData
     */
            ...
            switch ($fid) {
                ...
                case 3:
                    if ($ftype == TType::STRUCT) {
                        $this->meta_data = new \hongkaiwang365\parquet\format\ColumnMetaData();
                ...
                case 8:
                    if ($ftype == TType::STRUCT) {
                        $this->crypto_metadata = new \hongkaiwang365\parquet\format\ColumnCryptoMetaData();
