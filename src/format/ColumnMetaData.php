...
class ColumnMetaData
{
    ...
    static public $_TSPEC = array(
        ...
        12 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkaiwang365\parquet\format\Statistics',
        ),
        13 => array(
            'var' => 'encoding_stats',
            'isRequired' => false,
            ...
            'elem' => array(
                'type' => TType::STRUCT,
                'class' => '\hongkaiwang365\parquet\format\PageEncodingStats',
                ),
        ),
        14 => array(
     ...
     * 
     * @var \hongkaiwang365\parquet\format\Statistics
     */
     ...
     * 
     * @var \hongkaiwang365\parquet\format\PageEncodingStats[]
     */
            ...
            switch ($fid) {
                ...
                case 8:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i16 = 0; $_i16 < $_size12; ++$_i16) {
                            $elem17 = null;
                            $elem17 = new \hongkaiwang365\parquet\format\KeyValue();
                ...
                case 12:
                    if ($ftype == TType::STRUCT) {
                        $this->statistics = new \hongkaiwang365\parquet\format\Statistics();
                ...
                case 13:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i22 = 0; $_i22 < $_size18; ++$_i22) {
                            $elem23 = null;
                            $elem23 = new \hongkaiwang365\parquet\format\PageEncodingStats();
