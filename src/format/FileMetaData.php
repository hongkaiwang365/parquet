...
class FileMetaData
{
    ...
    static public $_TSPEC = array(
        ...
        2 => array(
            ...
            'elem' => array(
                'type' => TType::STRUCT,
                'class' => '\hongkaiwang365\parquet\format\SchemaElement',
                ),
        ),
        3 => array(
            'var' => 'num_rows',
        ...
        4 => array(
            ...
            'elem' => array(
                'type' => TType::STRUCT,
                'class' => '\hongkaiwang365\parquet\format\RowGroup',
                ),
        ),
        5 => array(
            ...
            'elem' => array(
                'type' => TType::STRUCT,
                'class' => '\hongkaiwang365\parquet\format\KeyValue',
                ),
        ),
        6 => array(
            'var' => 'created_by',
        ...
        7 => array(
            ...
            'elem' => array(
                'type' => TType::STRUCT,
                'class' => '\hongkaiwang365\parquet\format\ColumnOrder',
                ),
        ),
        8 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkaiwang365\parquet\format\EncryptionAlgorithm',
        ),
        9 => array(
     ...
     * 
     * @var \hongkaiwang365\parquet\format\SchemaElement[]
     */
    public $schema = null;
    /**
     ...
     * 
     * @var \hongkaiwang365\parquet\format\RowGroup[]
     */
    public $row_groups = null;
    /**
     * Optional key/value metadata *
     * 
     * @var \hongkaiwang365\parquet\format\KeyValue[]
     */
     ...
     * 
     * @var \hongkaiwang365\parquet\format\ColumnOrder[]
     */
     ...
     * 
     * @var \hongkaiwang365\parquet\format\EncryptionAlgorithm
     */
            ...
            switch ($fid) {
                ...
                case 2:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i88 = 0; $_i88 < $_size84; ++$_i88) {
                            $elem89 = null;
                            $elem89 = new \hongkaiwang365\parquet\format\SchemaElement();
                ...
                case 4:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i94 = 0; $_i94 < $_size90; ++$_i94) {
                            $elem95 = null;
                            $elem95 = new \hongkaiwang365\parquet\format\RowGroup();
                ...
                case 5:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i100 = 0; $_i100 < $_size96; ++$_i100) {
                            $elem101 = null;
                            $elem101 = new \hongkaiwang365\parquet\format\KeyValue();
                ...
                case 7:
                    if ($ftype == TType::LST) {
                        ...
                        for ($_i106 = 0; $_i106 < $_size102; ++$_i106) {
                            $elem107 = null;
                            $elem107 = new \hongkaiwang365\parquet\format\ColumnOrder();
                ...
                case 8:
                    if ($ftype == TType::STRUCT) {
                        $this->encryption_algorithm = new \hongkaiwang365\parquet\format\EncryptionAlgorithm();
