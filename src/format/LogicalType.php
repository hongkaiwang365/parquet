...
class LogicalType
{
    ...
    static public $_TSPEC = array(
        1 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkaiwang365\parquet\format\StringType',
        ),
        2 => array(
            'var' => 'MAP',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkaiwang365\parquet\format\MapType',
        ),
        3 => array(
            'var' => 'LIST',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkaiwang365\parquet\format\ListType',
        ),
        4 => array(
            'var' => 'ENUM',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkaiwang365\parquet\format\EnumType',
        ),
        5 => array(
            'var' => 'DECIMAL',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkaiwang365\parquet\format\DecimalType',
        ),
        6 => array(
            'var' => 'DATE',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkaiwang365\parquet\format\DateType',
        ),
        7 => array(
            'var' => 'TIME',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkaiwang365\parquet\format\TimeType',
        ),
        8 => array(
            'var' => 'TIMESTAMP',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkaiwang365\parquet\format\TimestampType',
        ),
        10 => array(
            'var' => 'INTEGER',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkaiwang365\parquet\format\IntType',
        ),
        11 => array(
            'var' => 'UNKNOWN',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkaiwang365\parquet\format\NullType',
        ),
        12 => array(
            'var' => 'JSON',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkaiwang365\parquet\format\JsonType',
        ),
        13 => array(
            'var' => 'BSON',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkaiwang365\parquet\format\BsonType',
        ),
        14 => array(
            'var' => 'UUID',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkaiwang365\parquet\format\UUIDType',
        ),
    );

    /**
     * @var \hongkaiwang365\parquet\format\StringType
     */
    public $STRING = null;
    /**
     * @var \hongkaiwang365\parquet\format\MapType
     */
    public $MAP = null;
    /**
     * @var \hongkaiwang365\parquet\format\ListType
     */
    public $LIST = null;
    /**
     * @var \hongkaiwang365\parquet\format\EnumType
     */
    public $ENUM = null;
    /**
     * @var \hongkaiwang365\parquet\format\DecimalType
     */
    public $DECIMAL = null;
    /**
     * @var \hongkaiwang365\parquet\format\DateType
     */
    public $DATE = null;
    /**
     * @var \hongkaiwang365\parquet\format\TimeType
     */
    public $TIME = null;
    /**
     * @var \hongkaiwang365\parquet\format\TimestampType
     */
    public $TIMESTAMP = null;
    /**
     * @var \hongkaiwang365\parquet\format\IntType
     */
    public $INTEGER = null;
    /**
     * @var \hongkaiwang365\parquet\format\NullType
     */
    public $UNKNOWN = null;
    /**
     * @var \hongkaiwang365\parquet\format\JsonType
     */
    public $JSON = null;
    /**
     * @var \hongkaiwang365\parquet\format\BsonType
     */
    public $BSON = null;
    /**
     * @var \hongkaiwang365\parquet\format\UUIDType
     */
    public $UUID = null;
            ...
            switch ($fid) {
                case 1:
                    if ($ftype == TType::STRUCT) {
                        $this->STRING = new \hongkaiwang365\parquet\format\StringType();
                ...
                case 2:
                    if ($ftype == TType::STRUCT) {
                        $this->MAP = new \hongkaiwang365\parquet\format\MapType();
                ...
                case 3:
                    if ($ftype == TType::STRUCT) {
                        $this->LIST = new \hongkaiwang365\parquet\format\ListType();
                ...
                case 4:
                    if ($ftype == TType::STRUCT) {
                        $this->ENUM = new \hongkaiwang365\parquet\format\EnumType();
                ...
                case 5:
                    if ($ftype == TType::STRUCT) {
                        $this->DECIMAL = new \hongkaiwang365\parquet\format\DecimalType();
                ...
                case 6:
                    if ($ftype == TType::STRUCT) {
                        $this->DATE = new \hongkaiwang365\parquet\format\DateType();
                ...
                case 7:
                    if ($ftype == TType::STRUCT) {
                        $this->TIME = new \hongkaiwang365\parquet\format\TimeType();
                ...
                case 8:
                    if ($ftype == TType::STRUCT) {
                        $this->TIMESTAMP = new \hongkaiwang365\parquet\format\TimestampType();
                ...
                case 10:
                    if ($ftype == TType::STRUCT) {
                        $this->INTEGER = new \hongkaiwang365\parquet\format\IntType();
                ...
                case 11:
                    if ($ftype == TType::STRUCT) {
                        $this->UNKNOWN = new \hongkaiwang365\parquet\format\NullType();
                ...
                case 12:
                    if ($ftype == TType::STRUCT) {
                        $this->JSON = new \hongkaiwang365\parquet\format\JsonType();
                ...
                case 13:
                    if ($ftype == TType::STRUCT) {
                        $this->BSON = new \hongkaiwang365\parquet\format\BsonType();
                ...
                case 14:
                    if ($ftype == TType::STRUCT) {
                        $this->UUID = new \hongkaiwang365\parquet\format\UUIDType();
