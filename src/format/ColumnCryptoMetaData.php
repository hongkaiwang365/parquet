...
class ColumnCryptoMetaData
{
    ...
    static public $_TSPEC = array(
        1 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkaiwang365\parquet\format\EncryptionWithFooterKey',
        ),
        2 => array(
            'var' => 'ENCRYPTION_WITH_COLUMN_KEY',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkaiwang365\parquet\format\EncryptionWithColumnKey',
        ),
    );

    /**
     * @var \hongkaiwang365\parquet\format\EncryptionWithFooterKey
     */
    public $ENCRYPTION_WITH_FOOTER_KEY = null;
    /**
     * @var \hongkaiwang365\parquet\format\EncryptionWithColumnKey
     */
            ...
            switch ($fid) {
                case 1:
                    if ($ftype == TType::STRUCT) {
                        $this->ENCRYPTION_WITH_FOOTER_KEY = new \hongkaiwang365\parquet\format\EncryptionWithFooterKey();
                ...
                case 2:
                    if ($ftype == TType::STRUCT) {
                        $this->ENCRYPTION_WITH_COLUMN_KEY = new \hongkaiwang365\parquet\format\EncryptionWithColumnKey();
