...
class ColumnOrder
{
    ...
    static public $_TSPEC = array(
        1 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\hongkaiwang365\parquet\format\TypeDefinedOrder',
        ),
    );
     ...
     * 
     * @var \hongkaiwang365\parquet\format\TypeDefinedOrder
     */
            ...
            switch ($fid) {
                case 1:
                    if ($ftype == TType::STRUCT) {
                        $this->TYPE_ORDER = new \hongkaiwang365\parquet\format\TypeDefinedOrder();
