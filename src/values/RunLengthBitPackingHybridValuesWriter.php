...
class RunLengthBitPackingHybridValuesWriter
{
  ...
  public static function WriteForwardOnly(BinaryWriter $writer, int $bitWidth, array $data, int $count): void
  {
    ...
    $bw = \hongkaiwang365\parquet\adapter\BinaryWriter::createInstance($ms);
    // $bw->setOrder(\hongkaiwang365\parquet\adapter\BinaryWriter::LITTLE_ENDIAN); // enforce little endian
    //
    ...
    // if($writer instanceof \hongkaiwang365\parquet\adapter\BinaryWriter) {
    //   $writer->insert()
    // }
